  ...
  return (
    <View style={styles.container}>
      ...
      <ParallaxScrollView
        ...
        backgroundSource={{
          uri: 'https://images.unsplash.com/photo-1511367461989-f85a21fda167?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8cHJvZmlsZXxlbnwwfHwwfHw%3D&w=1000&q=80',
        }}
          ...
          <View style={styles.signInContainer}>
            ...
            <View style={[styles.signInContainer, { marginTop: 0 }]}>
              ...
              {/* <View>
                ...
                <TouchableOpacity style={{ borderBottomWidth: 1, borderColor: "#b4b4b4", }} onPress={() => onSelectProfileData()}>
                  <LinkView
                    img={NEW_PROFILE_IMG.ANGLE_RIGHT}
                    // text={val.linkname}
                    // textDec={val.linkDescri}
                    desc={true}
